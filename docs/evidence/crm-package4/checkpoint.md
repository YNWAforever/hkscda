...
Disposable database acceptance now executed: final CRM suite17pass/0fail/90assertions. Real1001/5000/5001 filters/exports, deleted/consent predicates and1001gift totals passed. At5000rows decoded DB supporter envelope2,177,832B and donation envelope1,977,831B. See ../crm-package2/local-database-fifth-run.txt and its checkpoint for harness corrections, cleanup and limits. No migration edits.
