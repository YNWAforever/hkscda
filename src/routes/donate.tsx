  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-8 space-y-10">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        {donateMethods.map((d) => (
          <div key={d.title} className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl p-5 flex gap-4 hover:shadow-md transition-shadow">
      ...
      <div className="text-center">
        <a href="/sponsors" className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[var(--color-primary)] text-white font-bold hover:bg-[var(--color-primary-hover)] transition-colors">
