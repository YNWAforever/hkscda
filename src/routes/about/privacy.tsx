      ...
      {[
        {
          title: "1. 個人資料的收集",
          content:
            "香港拯救貓狗協會（「協會」）可能收集您的個人資料，包括姓名、聯絡電話、電郵地址及住址等，以處理領養申請、接受捐款及提供相關服務。我們只會收集所需的最少個人資料。",
        },
        {
          title: "2. 個人資料的使用",
          content:
            "您的個人資料將只用於：處理您的領養或助養申請；與您聯絡有關您的申請事宜；如您同意，向您發送協會的最新消息及活動資訊。我們不會將您的個人資料出售或出租予第三方。",
        },
        {
          title: "3. 個人資料的安全",
          content:
            "協會採取合理措施保護您的個人資料，防止未經授權的存取、披露、複製、使用或修改。所有個人資料均儲存在安全的系統內。",
        },
        {
          title: "4. 個人資料的披露",
          content:
            "在以下情況下，協會可能需要披露您的個人資料：根據法律規定；為保護協會的合法權益；獲得您的事先同意。",
        },
        {
          title: "5. 個人資料的保留",
          content:
