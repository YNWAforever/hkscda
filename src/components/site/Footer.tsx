...
export function Footer() {
  return (
    <footer
      id="contact"
      className="bg-[var(--color-primary)] px-4 pt-14 text-white sm:px-6 lg:px-8"
    >
      <div className="container-wide grid gap-10 pb-10 md:grid-cols-4">
          ...
          <ul className="space-y-3 text-sm text-white/85">
            ...
            <li>
              <a
                ...
                className="flex min-h-11 items-center gap-2 hover:text-white"
              >
                <Smartphone className="h-4 w-4 opacity-80" aria-hidden="true" /> WhatsApp / FPS:
                9864 1089
              </a>
            </li>
        ...
        <div>
          ...
          <div className="flex gap-3">
            <a
              ...
              className="flex h-11 w-11 items-center justify-center bg-white/10 hover:bg-white/20"
        ...
        <div>
          ...
          <ul className="space-y-1 text-sm text-white/85">
            <li>
              <a href="/report/adoption" className="flex min-h-11 items-center hover:text-white">
                每月領養報告
              </a>
            </li>
            <li>
              <a href="/report/audit" className="flex min-h-11 items-center hover:text-white">
                年度報告
              </a>
            </li>
            <li>
              <a href="/knowledge" className="flex min-h-11 items-center hover:text-white">
                知識資源
              </a>
            </li>
            <li>
              <a href="/donate" className="flex min-h-11 items-center hover:text-white">
                捐助我們
              </a>
            </li>
            <li>
              <a href="/volunteer" className="flex min-h-11 items-center hover:text-white">
                加入義工團隊
              </a>
            </li>
            <li>
              <a href="/volunteer/group" className="flex min-h-11 items-center hover:text-white">
                團體義工查詢
              </a>
            </li>
          </ul>
