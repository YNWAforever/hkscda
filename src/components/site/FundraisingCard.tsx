...
export function FundraisingCard() {
  return (
    <section className="px-6 py-16 lg:py-20 bg-[var(--color-surface)]" aria-labelledby="fundraising-h">
          ...
          <div className="relative">
            ...
            <div className="mb-7">
              <div className="flex justify-between items-end mb-2">
                <div>
                  <div className="text-[11px] text-[var(--color-text-muted)] font-medium">已籌得</div>
